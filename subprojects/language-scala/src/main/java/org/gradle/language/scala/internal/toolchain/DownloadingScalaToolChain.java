...
public class DownloadingScalaToolChain implements ScalaToolChainInternal {
    ...
    public ToolProvider select(ScalaPlatform targetPlatform) {
        try {
            ...
            return new DefaultScalaToolProvider(daemonWorkingDir, workerDaemonFactory, forkOptionsFactory, classPathRegistry, resolvedScalaClasspath, resolvedZincClasspath, classLoaderRegistry);
